...
class GeoServiceImplTest {
    ...
    public void testByIpMoscow(){
        ...
        Country expected = new Location("Moscow", Country.RUSSIA, null, 0).getCountry();
    ...
    public void testByIpNewYork(){
        ...
        Country actual = geoService.byIp("96.44.183.149").getCountry();
        Country expected = new Location("New York", Country.USA, null, 0).getCountry();
